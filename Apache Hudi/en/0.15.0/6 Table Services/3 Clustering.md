...
Particularly, [Merge-On-Read]($Table-Query-Types#merge-on-read-table)
...
![Clustering example](https://hudi.apache.org/assets/images/blog/clustering/clustering1_new.png)
...
![Batching small files](https://hudi.apache.org/assets/images/blog/clustering/clustering2_new.png)
...
![Batching small files](https://hudi.apache.org/assets/images/blog/clustering/clustering_3.png)
...
config [hoodie.clustering.plan.strategy.class]($All-Configurations#hoodieclusteringplanstrategyclass).
...
config [hoodie.clustering.execution.strategy.class]($All-Configurations#hoodieclusteringexecutionstrategyclass). By
...
the config for update strategy - [`hoodie.clustering.updates.strategy`]($All-Configurations#hoodieclusteringupdatesstrategy) is set to ***
...
listed [here]($All-Configurations#Clustering-Configs). Out of this list, a few configurations that will be very useful
