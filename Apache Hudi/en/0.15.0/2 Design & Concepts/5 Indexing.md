...
For [Copy-On-Write tables]($Table-Query-Types#copy-on-write-table), this enables fast upsert/delete operations, by
avoiding the need to join against the entire dataset to determine which files to rewrite.
For [Merge-On-Read tables]($Table-Query-Types#merge-on-read-table), this design allows Hudi to bound the amount of
...
![Fact table](https://hudi.apache.org//assets/images/blog/hudi-indexes/with_without_index.png)
...
![Fact table](https://hudi.apache.org/assets/images/blog/hudi-indexes/nosql.png)
...
![Event table](https://hudi.apache.org/assets/images/blog/hudi-indexes/event_bus.png)
...
![Dimensions table](https://hudi.apache.org/assets/images/blog/hudi-indexes/dimension.png)
