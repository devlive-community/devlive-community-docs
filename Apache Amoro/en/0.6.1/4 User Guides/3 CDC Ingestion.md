...
This section will show how to ingest one table or multiple tables into the data lake for both [Iceberg]($Iceberg) format and [Mixed-Iceberg]($Mixed-Iceberg) format.
...
Please add [Flink SQL Connector MySQL CDC](https://repo1.maven.org/maven2/com/ververica/flink-sql-connector-mysql-cdc/2.3.0/flink-connector-mysql-cdc-2.3.0.jar) and [Amoro](https://amoro.incubator.apache.org/download/) Jars to the lib directory of the Flink engine package.
