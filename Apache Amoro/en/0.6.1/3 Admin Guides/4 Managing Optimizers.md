...
![add-optimizer-group](https://amoro.incubator.apache.org/docs/0.6.1/images/admin/add-optimizer-group.png)

2.Configure the newly added Optimizer group.
![config-optimizer-group](https://amoro.incubator.apache.org/docs/0.6.1/images/admin/config-optimizer-group.png)
...
![optimize-scale-out](https://amoro.incubator.apache.org/docs/0.6.1/images/admin/optimizer_scale.png)

### Release optimizer

You can click the `Release` button on the `Optimizer` page to release the optimizer.

![release optimizer](https://amoro.incubator.apache.org/docs/0.6.1/images/admin/optimizer_release.png)
