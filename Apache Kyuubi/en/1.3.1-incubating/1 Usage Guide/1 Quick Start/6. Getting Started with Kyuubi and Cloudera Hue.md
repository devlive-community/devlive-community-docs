...
[Get the server Started]($Getting-Started-With-Kyuubi) first before your try Hue with Kyuubi.
...
![](https://kyuubi.readthedocs.io/en/v1.3.1-incubating/_images/start.png)

Having fun with Hue and Kyuubi!

![](https://kyuubi.readthedocs.io/en/v1.3.1-incubating/_images/spark_sql_docker.png)
...
![](https://kyuubi.readthedocs.io/en/v1.3.1-incubating/_images/cloudera_manager.png)
...
![](https://kyuubi.readthedocs.io/en/v1.3.1-incubating/_images/editor.png)

Having fun with Hue and Kyuubi!

![](https://kyuubi.readthedocs.io/en/v1.3.1-incubating/_images/spark_sql_cdh6.png)
