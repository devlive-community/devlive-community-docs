...
![](https://kyuubi.readthedocs.io/en/v1.3.1-incubating/_images/dra_task_pending.png)
...
![](https://kyuubi.readthedocs.io/en/v1.3.1-incubating/_images/dra_executor_added.png)
...
![](https://kyuubi.readthedocs.io/en/v1.3.1-incubating/_images/dra_executor_add_ratio.png)
...
![](https://kyuubi.readthedocs.io/en/v1.3.1-incubating/_images/dra_task_fin.png)
...
![](https://kyuubi.readthedocs.io/en/v1.3.1-incubating/_images/dra_executor_removal.png)
...
[Configuring by `spark-defaults.conf`]($Introduction-To-The-Kyuubi-Configurations-System#via-spark-defaults-conf) at the engine side is the best way to set up Kyuubi with DRA. All engines will be instantiated with DRA enabled.
...
Then we can set different defaults for them via the [User Defaults]($Introduction-To-The-Kyuubi-Configurations-System#user-defaults) in ```$KYUUBI_HOME/conf/kyuubi-defaults.conf```
...
Instead, end-users can set them via [JDBC Connection URL]($Introduction-To-The-Kyuubi-Configurations-System#via-jdbc-connection-url) for some specific cases.
