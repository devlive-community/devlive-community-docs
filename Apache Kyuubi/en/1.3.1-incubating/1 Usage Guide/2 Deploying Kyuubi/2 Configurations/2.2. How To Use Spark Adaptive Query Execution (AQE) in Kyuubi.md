...
![](https://kyuubi.readthedocs.io/en/v1.3.1-incubating/_images/aqe_switch_join.png)
...
![](https://kyuubi.readthedocs.io/en/v1.3.1-incubating/_images/localshufflereader.png)
...
![](https://kyuubi.readthedocs.io/en/v1.3.1-incubating/_images/blog-adaptive-query-execution-2.png)
...
![](https://kyuubi.readthedocs.io/en/v1.3.1-incubating/_images/blog-adaptive-query-execution-3.png)
...
![](https://kyuubi.readthedocs.io/en/v1.3.1-incubating/_images/blog-adaptive-query-execution-6.png)
...
[Configuring by `spark-defaults.conf`]($Introduction-To-The-Kyuubi-Configurations-System#via-spark-defaults-conf) at the engine side is the best way to set up Kyuubi with AQE. All engines will be instantiated with AQE enabled.
