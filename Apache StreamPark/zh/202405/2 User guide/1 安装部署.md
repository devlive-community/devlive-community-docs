...
使用 `Flink on Kubernetes`，需要额外部署/或使用已经存在的 Kubernetes 集群，请参考条目： [**StreamPark Flink-K8s 集成支持**](../6%20Deployment/1-deployment.md)。
...
![StreamPark Login](https://streampark.apache.org/doc/image/streampark_login.jpeg)
...
![StreamPark Settings](https://streampark.apache.org/doc/image/streampark_settings_2.0.0.png)
