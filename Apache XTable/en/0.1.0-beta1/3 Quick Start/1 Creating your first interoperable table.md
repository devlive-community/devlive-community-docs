...
> on the [Installation page]($Installation). Read through OneTable's
...
## Next steps
Go through the [Catalog Integration guides]($Catalogs) to register the OneTable synced tables
