...
To use Iceberg in Spark, first configure [Spark catalogs]($S-Configuration).

Some plans are only available when using [Iceberg SQL extensions]($S-Configuration#sql-extensions) in Spark 3.
