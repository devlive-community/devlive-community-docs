...
There are other options that can be set, please see the [FlinkSource#Builder](https://iceberg.apache.org/javadoc/1.5.2/org/apache/iceberg/flink/source/FlinkSource.html).
...
[IcebergSource#Builder](https://iceberg.apache.org/javadoc/1.5.2/org/apache/iceberg/flink/source/IcebergSource.html).
...
[write properties]($Configuration#write-properties) starting with `write.metadata.metrics` when needed.
