...
tables are created using either a [`Catalog`](https://iceberg.apache.org/javadoc/1.5.2/?org/apache/iceberg/catalog/Catalog.html), or an implementation of the [`Tables`](https://iceberg.apache.org/javadoc/1.5.2/?org/apache/iceberg/Tables.html) interface, and Hive needs to be configured accordingly to operate on these different types of table.
