...
The [`Table` interface](https://iceberg.apache.org/javadoc/1.5.2/?org/apache/iceberg/Table.html) provides access to the table metadata:
...
Iceberg data types are located in the [`org.apache.iceberg.types` package](https://iceberg.apache.org/javadoc/1.5.2/?org/apache/iceberg/types/package-summary.html).
...
Iceberg's expressions are used to configure table scans. To create expressions, use the factory methods in [`Expressions`](https://iceberg.apache.org/javadoc/1.5.2/?org/apache/iceberg/expressions/Expressions.html).
