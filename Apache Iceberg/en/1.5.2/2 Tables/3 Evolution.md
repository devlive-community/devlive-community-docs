...
![Partition evolution diagram](https://iceberg.apache.org/docs/1.5.2/assets/images/partition-spec-evolution.png)
...
Spark supports updating partition spec through its `ALTER TABLE` SQL statement, see more details in [Spark SQL]($DDL#alter-table-add-partition-field).
...
Spark supports updating sort order through its `ALTER TABLE` SQL statement, see more details in [Spark SQL]($DDL#alter-table-write-ordered-by).
