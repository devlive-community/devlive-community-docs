...
> Maintenance operations require the `Table` instance. Please refer [Java API quickstart]($Java-Quickstart#create-a-table) page to refer how to load an existing table.
...
Snapshots accumulate until they are expired by the [`expireSnapshots`](https://iceberg.apache.org/javadoc/1.5.2/org/apache/iceberg/Table.html#expireSnapshots--) operation. Regularly expiring snapshots is recommended to delete data files that are no longer needed, and to keep the size of table metadata small.
...
See the [`ExpireSnapshots` Javadoc](https://iceberg.apache.org/javadoc/1.5.2/org/apache/iceberg/ExpireSnapshots.html) to see more configuration options.
...
See the [DeleteOrphanFiles Javadoc](https://iceberg.apache.org/javadoc/1.5.2/org/apache/iceberg/actions/DeleteOrphanFiles.html) to see more configuration options.
...
See the [`RewriteDataFiles` Javadoc](https://iceberg.apache.org/javadoc/1.5.2/org/apache/iceberg/actions/RewriteDataFiles.html) to see more configuration options.
...
See the [`RewriteManifests` Javadoc](https://iceberg.apache.org/javadoc/1.5.2/org/apache/iceberg/actions/RewriteManifests.html) to see more configuration options.
