...
`where` is well suited to declaratively expressing constraints for other functions such as [`filter`](#filter) and [`find`](#find).

See also [propSatisfies](#propSatisfies), [whereEq](#whereEq).
