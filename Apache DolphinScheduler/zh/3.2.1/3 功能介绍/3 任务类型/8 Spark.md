...
- 拖动工具栏的 <img src="https://dolphinscheduler.apache.org/img/tasks/icons/spark.png" width="15"/> 任务节点到画板中。
...
![spark_configure](https://dolphinscheduler.apache.org/img/tasks/demo/spark_task01.png)

##### 上传主程序包

在使用 Spark 任务节点时，需要利用资源中心上传执行程序的 jar 包，可参考[资源中心]($Resource-Configuration)。
...
![demo-spark-simple](https://dolphinscheduler.apache.org/img/tasks/demo/spark_task02.png)
...
![spark_sql](https://dolphinscheduler.apache.org/img/tasks/demo/spark_sql.png)
