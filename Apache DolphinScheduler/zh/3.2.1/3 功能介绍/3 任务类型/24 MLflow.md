...
- 拖动工具栏的 <img src="https://dolphinscheduler.apache.org/img/tasks/icons/mlflow.png" width="15"/> 任务节点到画板中。
...
![mlflow-conda-env](https://dolphinscheduler.apache.org/img/tasks/demo/mlflow-basic-algorithm.png)
...
![mlflow-automl](https://dolphinscheduler.apache.org/img/tasks/demo/mlflow-automl.png)
...
![mlflow-custom-project.png](https://dolphinscheduler.apache.org/img/tasks/demo/mlflow-custom-project.png)
...
![mlflow-models-mlflow](https://dolphinscheduler.apache.org/img/tasks/demo/mlflow-models-mlflow.png)

#### Docker

![mlflow-models-docker](https://dolphinscheduler.apache.org/img/tasks/demo/mlflow-models-docker.png)
...
![mlflow-conda-env](https://dolphinscheduler.apache.org/img/tasks/demo/mlflow-conda-env.png)

后续注意配置任务时，环境选择上面创建的conda环境，否则程序会找不到conda环境。

![mlflow-set-conda-env](https://dolphinscheduler.apache.org/img/tasks/demo/mlflow-set-conda-env.png)
...
![mlflow-server](https://dolphinscheduler.apache.org/img/tasks/demo/mlflow-server.png)
