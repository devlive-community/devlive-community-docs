...
- 拖动工具栏的 <img src="https://dolphinscheduler.apache.org/img/tasks/icons/dms.png" width="15"/> 任务节点到画板中。
...
![dms](https://dolphinscheduler.apache.org/img/tasks/demo/dms_create_and_start.png)

**重启已存在的迁移任务（通过界面）**

![dms](https://dolphinscheduler.apache.org/img/tasks/demo/dms_restart.png)

**创建并启动迁移任务（通过Json数据）**

![dms](https://dolphinscheduler.apache.org/img/tasks/demo/dms_create_and_start_json.png)

**重启已存在的迁移任务（通过Json数据）**

![dms](https://dolphinscheduler.apache.org/img/tasks/demo/dms_restart_json.png)
