...
- 工具栏中拖动 <img src="https://dolphinscheduler.apache.org/img/tasks/icons/shell.png" width="15"/> 到画板中，即可完成创建。
...
![demo-shell-simple](https://dolphinscheduler.apache.org/img/tasks/demo/shell.jpg)
...
![demo-shell-custom-param](https://dolphinscheduler.apache.org/img/tasks/demo/shell_custom_param.jpg)
...
如果 Shell 任务中需要使用到用户自定义的脚本，可通过资源中心来上传对应的文件然后在 Shell 任务中引用他们，可参考：[文件管理]($Resource-File-Manage)。
