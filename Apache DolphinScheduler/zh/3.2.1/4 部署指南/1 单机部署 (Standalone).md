...
如果你是新手，想要体验 DolphinScheduler 的功能，推荐使用 Standalone 方式体检。如果你想体验更完整的功能，或者更大的任务量，推荐使用[伪集群部署]($Deployment-Pseudo-Cluster)。如果你是在生产中使用，推荐使用[集群部署]($Deployment-Cluster)或者[kubernetes]($Deployment-Kubernetes)
...
![登录页面](https://dolphinscheduler.apache.org/img/new_ui/dev/quick-start/login.png)
