...
3.  Load the example site at [http://localhost:3000](http://localhost:3000/) if it did not already open automatically. If port 3000 has already been taken, another port will be used. Look at the console messages to see which.
...
![Image 1](https://v1.docusaurus.io/img/getting-started-preparation-verify.png)
